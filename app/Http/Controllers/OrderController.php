...
class OrderController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        // Salva total na sessão para o select de parcelas no step3
    ...
    public function confirm(Request $request)
    {
        ...
        // PIX é sempre à vista; cartão usa o valor enviado pelo formulário
        $installments = $request->payment_method === 'pix'
            ? 1
            : (int) $request->input('installments', 1);

        session([
            'checkout_payment'      => $request->payment_method,
            'checkout_installments' => $installments,
        ]);

        $payment = $request->payment_method;

        return view('checkout.step4', compact('cartItems', 'total', 'address', 'payment', 'installments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        session()->forget(['checkout_address', 'checkout_payment', 'checkout_installments', 'checkout_total']);

...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .item-price .installment { font-size: 11px; color: var(--muted); margin-top: 2px; text-align: right; }
...
<div class="checkout-wrap">
    ...
    <!-- Pagamento -->
    @php $payment = session('checkout_payment'); @endphp
    @if($payment)
    <div class="card">
        <div class="card-header">
            <span style="color:var(--accent);font-size:16px;"></span>
        ...
        <div style="padding:16px 20px;">
            <span class="payment-badge">
                {{ $payment === 'pix' ? '◆ PIX — Aprovação imediata' : '💳 Cartão de Crédito — 12x sem juros' }}
            </span>
        </div>
    </div>
    @endif

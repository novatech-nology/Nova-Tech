...
<body>
    ...
    @if(session('success'))
        <div class="flash"><span class="check">âœ“</span> {{ session('success') }}</div>
    @endif
            ...
            <form class="filter-form" method="GET" action="{{ route('loja') }}">
                ...
                <div class="filter-field">
                    ...
                    <select id="price_range" name="price_range">
                        ...
                        <option value="1500-3000" @selected($selectedPriceRange === '1500-3000')>R$ 1.500 à R$ 3.000</option>
                        <option value="3000-5000" @selected($selectedPriceRange === '3000-5000')>R$ 3.000 à R$ 5.000</option>

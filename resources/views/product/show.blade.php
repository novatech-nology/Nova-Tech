...
<head>
    ...
    <title>{{ $product->name }} — {{ config('app.name', 'Nova Tech') }}</title>
...
<div class="page">
    <div class="product-wrapper">
        ...
        <div class="product-info">
            ...
            <div class="memory-title">Armazenamento</div>

<div class="memory-options">
    <button class="memory-btn active">128 GB</button>
    <button class="memory-btn">256 GB</button>
    <button class="memory-btn">512 GB</button>
</div>
<script>
